 ...
 *                            info (IOMMU_HWPT_ALLOC_DATA_VTD_S1)
...
/**
 * enum iommu_hwpt_data_type - IOMMU HWPT Alloc Data Type
 * @IOMMU_HWPT_ALLOC_DATA_NONE: no data
 * @IOMMU_HWPT_ALLOC_DATA_VTD_S1: Intel VT-d stage-1 page table
 * @IOMMU_HWPT_ALLOc_DATA_ARM_SMMUV3: ARM SMMUv3 Translation table
 */
enum iommu_hwpt_data_type {
	IOMMU_HWPT_ALLOC_DATA_NONE,
	IOMMU_HWPT_ALLOC_DATA_VTD_S1,
	IOMMU_HWPT_ALLOc_DATA_ARM_SMMUV3,
};
 ...
 * IOAS via the @pt_id. The @data_type for this allocation can be set to
 * either IOMMU_HWPT_ALLOC_DATA_NONE or a pre-defined type corresponding to
 ...
 *
 * If the @data_type is set to IOMMU_HWPT_ALLOC_DATA_NONE, @data_len and
