 ...
 * @IOMMU_VTD_S1_PCD: Page-level cache disable
 * @IOMMU_VTD_S1_PWT: Page-level write through
 * @IOMMU_VTD_S1_CD: PASID-level cache disable
 * @IOMMU_VTD_S1_WPE: Write protect enable
 */
enum iommu_hwpt_vtd_s1_flags {
	IOMMU_VTD_S1_SRE = 1 << 0,
	IOMMU_VTD_S1_EAFE = 1 << 1,
	IOMMU_VTD_S1_PCD = 1 << 2,
	IOMMU_VTD_S1_PWT = 1 << 3,
	IOMMU_VTD_S1_CD = 1 << 5,
	IOMMU_VTD_S1_WPE = 1 << 6,
	IOMMU_VTD_S1_LAST = 1 << 7,
};
 ...
 * space of the specified stage-2 page table. Hence the stage-1 page
 * table base address value should not exceed the maximum allowed input
 * address of stage-2.
 */
 ...
 * @addr==0 and @npages==__aligned_u64(-1).
 */
