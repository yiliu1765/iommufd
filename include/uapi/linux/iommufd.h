...
/**
 * struct iommu_pgtbl_config_vtd - Intel VT-d specific data on user managed pgtbl
 *
...
union iommu_pgtbl_config {
	struct iommu_pgtbl_config_vtd vtd;
};
...
/**
 * struct iommu_cache_invalidate_info - ioctl(IOMMU_HWPT_INVAL_CACHE)
 * @size: sizeof(struct iommu_cache_invalidate_info)
 * @flags: Must be 0
...
#define IOMMU_HWPT_INVAL_CACHE _IO(IOMMUFD_TYPE, IOMMUFD_CMD_HWPT_INVAL_CACHE)
#endif
