...
/**
 * enum iommu_hwpt_vtd_s1_invalidate_error_code - Result of invalidation
 ...
 *                                           of VT-d specification.
 */
enum iommu_hwpt_vtd_s1_invalidate_error_code {
	IOMMU_HWPT_VTD_S1_INVALIDATE_DEVTLB_ICE = 1 << 0,
	IOMMU_HWPT_VTD_S1_INVALIDATE_DEVTLB_ITE = 1 << 1,
};
 ...
 * @__reserved: Must be 0.
 * @error_code: One of enum iommu_hwpt_vtd_s1_invalidate_error_code
