 ...
 * +------------------------------+-------------------------------------+-----------+
 * | IOMMU_HWPT_TYPE_ARM_SMMUV3   |      struct iommu_hwpt_arm_smmuv3   |    HWPT   |
 * +------------------------------+-------------------------------------------------+
 */
...
/**
 * struct iommu_hw_info_vtd - Intel VT-d device info
 *
 ...
 *
 * Intel hardware iommu information.
 */
 ...
 * to check the the hardware IOMMU capability since stage-1 translation
 * table is owned by user but used by hardware IOMMU.
 *
 ...
 * user-managed hw_pagetable with user data, but no need if no user data
 * is needed as it is supported by default.
 */
