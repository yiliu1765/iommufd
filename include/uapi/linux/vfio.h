...
/*
 * VFIO_DEVICE_ATTACH_IOMMUFD - _IOW(VFIO_TYPE, VFIO_BASE + 20,
 *				  struct vfio_device_attach_iommufd)
 *
 ...
 * @ioas_id:	Input the target I/O address space or a hardware page table.
...
#define VFIO_DEVICE_ATTACH_IOMMUFD	_IO(VFIO_TYPE, VFIO_BASE + 20)

/*
 * VFIO_DEVICE_DETACH_IOMMUFD - _IOW(VFIO_TYPE, VFIO_BASE + 21,
 *				  struct vfio_device_detach_iommufd)
 *
 * Detach a vfio device from the hardware page table it was attached
 * to.
 *
 * @argsz:	user filled size of this data.
 * @flags:	reserved for future extension.
...
#define VFIO_DEVICE_DETACH_IOMMUFD	_IO(VFIO_TYPE, VFIO_BASE + 21)
