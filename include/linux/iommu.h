 ...
 *                    bit 0 of ops->hwpt_type_bitmap is not used as value 0
 *                    of enum iommu_hwpt_type stands for a type which is
 *                    supported by default. No need to check bitmap, hence
 *                    it is not used.
