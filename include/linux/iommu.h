 ...
 *                     domain_alloc, it requires iommu driver to fully initialize
 *                     a new domain including the generic iommu_domain struct.
 ...
 *                         is the info to get a driver data structure that must
