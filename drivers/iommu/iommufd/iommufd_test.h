...
/* Should not be equal to any defined value in enum iommu_idev_data_type */
#define IOMMU_IDEV_DATA_SELFTEST	0xdeed

/**
 * struct iommu_test_device_data
 *
 * @val: Should be set to IOMMU_TEST_DEVICE_VAL or unset to 0x0
 */
struct iommu_test_device_data {
#define IOMMU_TEST_DEVICE_VAL		0xdadbeef
	__u32 val;
};
