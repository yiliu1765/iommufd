...
static inline int iommufd_handle_attach_dev(struct iommufd_hw_pagetable *hwpt,
					    struct iommufd_device *idev,
					    ioasid_t pasid)
{
...
static inline int iommufd_handle_replace_dev(struct iommufd_device *idev,
					     ioasid_t pasid,
					     struct iommufd_hw_pagetable *hwpt,
					     ...
					     ioasid_t pasid)
{
	...
	return iommufd_handle_attach_dev(hwpt, idev, pasid);
}
					      ...
					      struct iommufd_hw_pagetable *old)
{
	...
	return iommufd_handle_replace_dev(idev, pasid, hwpt, old);
}
