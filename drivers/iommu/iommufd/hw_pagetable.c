				...
				bool dummy)
{
	...
	/*
	 * Either driver is buggy by missing cache_invalidate_user or having an
	 * invalid cache_invalidate_user_data_len, or the invalidate struct used
	 * by the driver is missing in union iommu_cache_invalidate_user_data.
	 */
...
int iommufd_hwpt_invalidate(struct iommufd_ucmd *ucmd)
{
	 ...
	 * must be added to union iommu_cache_invalidate_user_data.
	 */
