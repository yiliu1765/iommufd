...
static void vfio_device_register_group(struct vfio_device *device)
{
...
static void vfio_device_unregister_group(struct vfio_device *device)
{
	mutex_lock(&device->group->device_lock);
		...
		struct vfio_group *group)
{
	...
	vfio_device_register_group(device);
...
void vfio_unregister_group_dev(struct vfio_device *device)
{
	...
	vfio_device_unregister_group(device);
 ...
 */
static void vfio_group_lock(struct vfio_group *group)
{
	mutex_lock(&group->group_lock);
}

static void vfio_group_unlock(struct vfio_group *group)
{
...
static int vfio_device_first_open(struct vfio_device *device)
{
	...
	vfio_group_unlock(device->group);
	return 0;
