...
static int _test_cmd_hwpt_alloc(int fd, __u32 device_id, __u32 pt_id,
				__u32 flags, __u32 hwpt_type, __u32 data_len,
				uint64_t data_uptr, __u32 *hwpt_id)
{
...
#define test_cmd_hwpt_alloc_user(device_id, pt_id, flags, hwpt_type,     \
				 data_len, data, hwpt_id)                \
	ASSERT_EQ(0, _test_cmd_hwpt_alloc(self->fd, device_id, pt_id,    \
					  flags, hwpt_type, data_len,    \
					  (uint64_t)data, hwpt_id))
#define test_err_hwpt_alloc_user(_errno, device_id, pt_id, flags,     \
				     hwpt_type, data_len, data, hwpt_id)  \
	EXPECT_ERRNO(_errno,                                              \
